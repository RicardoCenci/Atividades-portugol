programa
{
	...
	inteiro NUMERO, CONTADOR=1, n1=1 , n2=1 , n3=1
		...
		escreva("Escreva o numero da Sequencia de Fibonacci que você deseja \n")	//NOTE QUE: "\n" SERVE PARA QUEBRA DE LINHA
			
		leia(NUMERO) 		//Le o numero desejado da Sequencia de Fibonacci
			
		enquanto( CONTADOR < NUMERO-1 ){	//Enquanto a variavel NUMERO for maior que a variavel CONTADOR o algorimo ira executar o bloco abaixo 
		{
		...
		escreva("O numero correspondente a posição ", NUMERO, " na Sequencia de Fibonacci é ", n1, "\n Obrigado, Volte sempre") //Escreve o numero de N1
	}
	//Vendo isso aqui depois de mais de um ano estudando não consigo entender nada mesmo com os comentarios, de nada
}
/* $$$ Portugol Studio $$$ 
 * 
